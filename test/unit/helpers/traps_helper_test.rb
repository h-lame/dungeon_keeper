...
class TrapsHelperTest < ActionView::TestCase
  context "dungeons_a_trap_is_installed_in" do
    should "return a link to each dungeon the trap is installed in" do
    ...
    should "return a link to adding a new trap installation if the trap hasn't been installed in any dungeons" do
      t = Trap.create!(:name => 'Spiky falling block', :base_damage_caused => 20)
